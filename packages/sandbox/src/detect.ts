...
const AGENT_INSTALL_COMMANDS = {
  ...
  none: null,
} as const satisfies Record<AgentType, string | null>
...
export const generateDevcontainerConfig = ({
  ...
  const containerWorkspace = `/workspaces/${repoName}`
  ...
  const config: DevcontainerConfig = {
    ...
    workspaceMount: `source=${workspacePath},target=${containerWorkspace},type=bind`,
