...
describe('gateway-client', () => {
  ...
  describe('listSandboxes', () => {
    it('should return sandbox list', async () => {
      const sandboxes = [{ id: 'abc-123', repo: '/tmp/repo', agent: 'claude', state: 'running' }]
  ...
  describe('createSandbox', () => {
    ...
    it('should throw on validation error', async () => {
      ...
      await expect(createSandbox({ repo: '' })).rejects.toThrow(
        'Gateway error (400): repo is required',
      )
    })
  })
  ...
  describe('getSandbox', () => {
    ...
    it('should throw on 404', async () => {
      ...
      await expect(getSandbox('nonexistent')).rejects.toThrow(
        'Gateway error (404): Sandbox not found',
      )
    })
  })
  ...
  describe('deleteSandbox', () => {
    ...
    it('should throw on 404', async () => {
      ...
      await expect(deleteSandbox('nonexistent')).rejects.toThrow(
        'Gateway error (404): Sandbox not found',
      )
    })
  })
